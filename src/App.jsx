...
import { Btn, ConfirmDialog, EmptyState, Input, ModernTab, Select, StatCard, TextArea } from "./components/ui";
import {
  LIVE_CHANNEL_NAME,
  duplaConcluida,
  duplaSat,
      ...
      <div style={{ background: "#1A1A1A", borderBottom: "1px solid #2A2A2A", padding: "14px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px", minWidth: 0 }}>
          <img
            src={LOGO_B64}
            alt="Logo"
            style={{ height: "38px", objectFit: "contain", mixBlendMode: "screen" }}
          />
